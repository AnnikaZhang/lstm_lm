...
train_data, train_target = load_sentence("bobsue.prevsent.train.txt")
dev_data, dev_target = load_sentence("bobsue.prevsent.dev.txt")
test_data, test_target = load_sentence("bobsue.prevsent.test.txt")
